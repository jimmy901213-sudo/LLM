...
def load_system():
    ...
    llm, retriever_products, retriever_rules, err = llm_core.init_llm_and_retrievers(db_path)
    if err:
    ...
    try:
        ...
        return None, None, None, f"系統初始化失敗：{e}", None, None, None
            ...
            if not product_query_final:
                ...
                with st.spinner("系統正在思考..."):
                    try:
                        ...
                        product_docs = search.get_documents_from_retriever(prod_retriever, product_query_final, k=1)
